...
public class ReverseSubpartOfLL {
    static void main(String[] args) {

    }
    //Approach 1 use dummmy node and break LL into 3 LL
    //Reverse the subpart using method and then link head to tail and return dummy.next;
